            ...
            case 'antilink':
                {
                    ...
                    if (!checkgroup) {
                        await new sck({ id: msg.chat, antilink: "false" })
                            .save()
                       ...
                       case 'economy':
                {
                    let checkgroup = await sck.findOne({ id: msg.chat })
                    if (!checkgroup) {
                        await new sck({ id: msg.chat, economy: "false" })
                            .save()
                ...
                case 'events':
                    {
                        let checkgroup = await sck.findOne({ id: msg.chat })
                        if (!checkgroup) {
                            await new sck({ id: msg.chat, events: "false" })
                                .save()
                ...
                case 'nsfw':
                    {
                        let checkgroup = await sck.findOne({ id: msg.chat })
                        if (!checkgroup) {
                            await new sck({ id: msg.chat, nsfw: "false" })
                                .save()
